                ...
                <tr>
                    <td width=708 valign=top bordercolor="#000000" class="body_text">
                        <table width="100%" border="0" align="center" cellpadding="10" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="6" align="left" class="body_text"><p><img
                                                src="images/images/lcd_pinkrose.jpg" alt="by Liane Collot d'Herbois"
                                                width="220" height="270" class="image_frame_right"></p>
                                    <br><br>
                                    <hr>
                                    <p>Welcome to <a href="index.html">www.lightcoloranddarkness.org</a>, a networking
                                        website created to further the artistic and therapeutic work of Liane Collot d&rsquo;Herbois.
                                        <br>
                                    </p>
                                    <p>Our goal is to help develop awareness of this extraordinary and innovative work
                                        and to provide information on opportunities for practice and further study. We
                                        will present educational articles related to the study of Light, Color and
                                        Darkness, as well as Painting Therapy, and are open to contributions from
                                        others. Our outreach efforts include courses in the study of Light, Color &amp;
                                        Darkness and their relationship to the human being, artistic and therapeutic
                                        charcoal drawing and veil painting. </p>
                                    <hr>
                                    <p align="center"><span class="style2">New Courses</span></p>
                                    <p align="left"><strong>Grass Valley, Fair Oaks, Sacramento &amp; San Rafael,
                                            California &amp; Portland, Oregon</strong><br>


                                        Veil painting in Sacramento one Saturday a month.<br>
                                        Upcoming classes in Grass Valley. </p>
                                    <p align="left"><em><a href="education.php">Click on the Education tab for details
                                                on courses, registration and dates. </a></em></p>
                  ...
                  <p><strong>FROM DUST TO LIGHT</strong></p>
                    ...
                    <p>&nbsp;</p>
                                    ...
                                    <p><strong><img src="images/images/liane2.jpg" alt="Liane Collot d'Herbois"
                                                    width="230" height="210" class="image_frame_right">Liane Collot d&rsquo;Herbois,</strong>
                                        Artist and Originator of Painting Therapy out of Light, Color and
                                        Darkness<u></u><br>
                                        Liane Collot d&rsquo;Herbois (1907-1999) built upon the color work of Goethe and
                                        Rudolf Steiner, emphasizing the creative forces of light and darkness in
                                        painting, both artistically and therapeutically. She showed how the result of
                                        the dynamic meeting of light and darkness is movement that manifests as visible
                                        color in a transparent color space. Through using the resulting laws of Light,
                                        Color and Darkness one can move beyond subjectivity into a world of greater
                                        objective significance. Her early work with people of all ages showed her
                                        tremendous talent for seeing how constitution, temperament and illness can be
                                        revealed in one&rsquo;s paintings. By working closely with Ita Wegman and other
                                        physicians, she developed her insights into a Painting Therapy based on the
                                        foundation of Anthroposophy, demonstrating the direct connection and healing
                                        possibilities of Light, Color and Darkness to the human being on all levels. Her
                                        therapeutic insights and transformative paintings have inspired doctors,
                                        therapists, artists, and those seeking a connection with spirit all over the
                                        world. </p>
                                    <p><img src="images/images/lcd_grnred.jpg" alt="Painting by Liane Collot d'Herbois"
                                            width="215" height="274" class="image_frame_left"> <img
                                                src="images/images/lcd_soul.jpg" alt="Painting by LianeCollot d'Herbois"
                                                width="215" height="274" class="image_frame_right"></p>
                                    <p><em>(Please click on the <a href="liane.php">Liane Collot d&rsquo;Herbois</a> tab
                                            to read more.)</em></p></td>
                            </tr>
                        </table>
                        <?php
                        include 'footer.php';
